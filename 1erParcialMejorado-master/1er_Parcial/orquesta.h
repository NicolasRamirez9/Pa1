 ...
 */
int inicializarOrquesta(Orquesta *eOrquesta,
                        int cant);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarElVacioOrquesta(Orquesta *eOrquesta,
                          int cant,
                          int *indice);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int altaOrquesta(Orquesta *eOrquesta,
                 int cant,
                 int posLibre);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarIdOrquesta(Orquesta *eOrquesta,
                     int cant,
                     int *idEncontrado);
 ...
 * \return void
 */
void imprimirOrquestas(Orquesta *eOrquesta,
                       int cant);
