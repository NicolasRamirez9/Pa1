 ...
 */
int inicializarMusico(Musico *eMusico,
                      int cant);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarElVacioMusico(Musico *eMusico,
                        int cant,
                        int *indice);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarIdMusico (Musico *eMusico,
                    int cant,
                    int *idEncontrado);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int modificarMusico(Musico *eMusico,
                    Orquesta *eOrquesta,
                    int cant);
 ...
 * \return int Return (0) if Ok
 */
int bajaOrquesta(Orquesta *eOrquesta,
                 Musico *eMusico,
                 int cantUno,
                 int cantDos);
 ...
 * \return void
 */
void imprimirMusico(Musico *eMusico,
                    Instrumento *eInstrumento,
                    int cantUno,
                    int cantDos);
