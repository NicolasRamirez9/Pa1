 ...
 */
int inicializarInstrumento(Instrumento *eInstrumento,
                           int cant);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarElVacioInstrumento(Instrumento *eInstrumento,
                             int cant,
                             int *indice);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int altaInstrumento(Instrumento *eInstrumento,
                    int cant,
                    int posLibre);
 ...
 * \return int Return (-1) if Error [Invalid length or NULL pointer] - (0) if Ok
 */
int buscarIdInstrumento(Instrumento *eInstrumento,
                        int cant,
                        int *idEncontrado);
 ...
 * \return void
 */
int imprimirInstrumentos(Instrumento *eInstrumento,
                         int cant);
